...
public class EmployeeManager {
	static ArrayList<Employee> employes = new ArrayList<Employee>();
	 ...
	 */
	public static void insertEmployeeRecord(List<Employee> employes) {
	...
	private static int findEmployeeMaxSalary() {
		...
		int maxSalary = employes.get(0).salary;
		for (Employee employee : employes) {
